...
SmashUploaderJS is a simple and easy-to-use JavaScript library for uploading files using the Smash [API file transfer](https://api.fromsmash.com/) service. With SmashUploaderJS, you can integrate Smash's file upload functionality directly into your web applications.
